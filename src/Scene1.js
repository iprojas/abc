...
function Title({ layers, ...props }) {
  ...
  const textRef2 = useLayers(layers)
  const textRef3 = useLayers(layers)

  return (
    <group {...props} ref={group}>
      <Text ref={textRef} name="text-panna" position={[0, 2, 0]} depthTest={false} material-toneMapped={false} material-color="#FFFFFF" {...TEXT_PROPS}>
        ANYTHING
      </Text>
      <Text ref={textRef2} name="text-panna2" position={[0, 0, 0]} depthTest={false} material-toneMapped={false} material-color="#FFFFFF" {...TEXT_PROPS}>
        BUT
      </Text>
      <Text ref={textRef3} name="text-panna3" position={[0, -2, 0]} depthTest={false} material-toneMapped={false} material-color="#FFFFFF" {...TEXT_PROPS}>
        CHEAP
      </Text>
    </group>
  )
